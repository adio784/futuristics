            ...
            <div class="flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
                ...
                <div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
                    ...
                    <div class="flex items-center gap-1"> 
                        ...
                        <div id="logo">
                            <a href="#"> 
                                <h4 className="text-white text-bolder">Futuristics</h4>
                                {/* <img src={Logos} alt="" class="w-28 md:block hidden dark:!hidden"></img>
                                <img src={Logol} alt="" class="dark:md:block hidden"></img>
                                <img src={Logom} class="hidden max-md:block w-20 dark:!hidden" alt=""></img>
                                <img src={Logoml} class="hidden dark:max-md:block w-20" alt=""></img> */}
                            </a>
                        </div>
                ...
                <div class="flex-1 relative">
                    ...
                    <div class="max-w-[1220px] mx-auto flex items-center">
                        ...
                        <div id="search--box" class="xl:w-[680px] sm:w-96 sm:relative rounded-xl overflow-hidden z-20 bg-secondery max-md:hidden w-screen left-0 max-sm:fixed max-sm:top-2 dark:!bg-white/5">
                            ...
                            <input type="text" placeholder="Search Friends, videos .." class="w-full !pl-10 !font-normal !bg-white h-12 !text-sm"/>
                        </div>  
                        ...
                        <div class="hidden uk- open z-10"
                                ...
                                <div class="xl:w-[694px] sm:w-96 bg-white dark:bg-dark3 w-screen p-2 rounded-lg shadow-lg -mt-14 pt-14">
                                    ...
                                    <nav class="text-sm font-medium text-black dark:text-white">
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={Avatar2} class="w-9 h-9 rounded-full"></img> <div>   <div> Jesse Steeve </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Friend </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={Avatar2} class="w-9 h-9 rounded-full"></img> <div>   <div>  Martin Gray </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Friend </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={Avatar3} class="w-9 h-9 rounded-full"></img> <div>   <div>  Delicious Foods  </div>  <div class="text-xs text-rose-500 font-medium mt-0.5">  Group </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={Avatar3} class="w-9 h-9 rounded-full"></img> <div>   <div> Delicious Foods  </div>  <div class="text-xs text-yellow-500 font-medium mt-0.5">  Page </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={Avatar6} class="w-9 h-9 rounded-full"></img> <div>   <div>  John Welim </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Friend </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                        ...
                        <div class="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
                            ...
                            <button type="button" class="sm:p-2 p-1 rounded-full relative sm:bg-secondery dark:text-white">
                                ...
                                <ion-icon name="add-circle-outline" class="sm:hidden !bg-black text-2xl "></ion-icon>
                            </button>
                                ...
                                <div class="mt-4" tabindex="-1" uk-slider="finite:true;sets: true">
                                    ...
                                    <ul class="-m-1 mt-4 pb-1 text-xs text-gray-500 dark:text-white" uk-scrollspy="target: > li; cls: uk-animation-scale-up , uk-animation-slide-bottom-small ;repeat: true">
                                        <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                            <img src={group} alt="" class="w-7"></img>
                                            <div class="flex-1">
                                        ...
                                        <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                            <img src={pageg} alt="" class="w-7"></img>
                                            <div class="flex-1">
                                        ...
                                        <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                            <img src={market} class="w-8 -ml-1"></img>
                                            <div class="flex-1">
                                                <a href="timeline.html"><h4 class="font-medium text-sm text-black dark:text-white"> Event </h4></a>
                                        ...
                                        <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                            <img src={game} alt="" class="w-7"></img>
                                            <div class="flex-1">
                            ...
                            <div  class="hidden bg-white pr-1.5 rounded-lg drop-shadow-xl dark:bg-slate-700 md:w-[365px] w-screen border2"
                                ...
                                <div class="text-sm h-[200px] w-full overflow-y-auto pr-2">
                                    ...
                                    <div class="pl-2 p-1 text-sm font-normal dark:text-white">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10 bg-teal-500/5">
                                            <div class="relative w-12 h-12 shrink-0"> <img src={Avatar3} alt="" class="object-cover w-full h-full rounded-full"></img></div>
                                            <div class="flex-1 ">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src={Avatar2} alt="" class="object-cover w-full h-full rounded-full"></img></div>
                                            <div class="flex-1 ">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src={Avatar7} alt="" class="object-cover w-full h-full rounded-full"></img></div>
                                            <div class="flex-1 ">
                            ...
                            <div  class="hidden bg-white pr-1.5 rounded-lg drop-shadow-xl dark:bg-slate-700 md:w-[360px] w-screen border2"
                                ...
                                <div class="h-30 overflow-y-auto pr-2">
                                    ...
                                    <div class="p-2 pt-0 pr-1 dark:text-white/80">
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src={Avatar2} alt="" class="object-cover w-full h-full rounded-full"></img>
                                            </div>
                            ...
                            <div  class="rounded-full relative bg-secondery cursor-pointer shrink-0">
                                <img src={Avatar2} alt="" class="sm:w-9 sm:h-9 w-7 h-7 rounded-full shadow shrink-0"></img>
                            </div>
                            ...
                            <div class="flex items-center gap-2 hidden">
                                ...
                                <img src={Avatar2} alt="" class="w-9 h-9 rounded-full shadow"></img>
