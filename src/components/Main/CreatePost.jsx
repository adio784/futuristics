...
import Affect from "../../assets/images/affect.jpg";
            ...
            <div className="lg:inline-flex">
                ...
                <div className="lg:w-[600px] w-full">  
                    ...
                    <div className="w-full lg:h-[600px] h-80 relative overflow-hidden flex justify-center items-center">
                        ...
                        <label for="addPostUrl" className="w-full h-full absolute inset-0 z-10 hover: cursor-pointer">
                        ...
                        <img id="addPostImage" src={'#'} alt="Uploaded Image" accept="image/png, image/jpeg" style="display:none;" className="w-full h-full absolute object-cover fff"></img>
                                ...
                                <div className="p-3.5">
                                    ...
                                    <div className="uk-switcher">
                                        ...
                                        <div className="space-y-8 py-6 p-1 text-sm font-medium text-gray-700 dark:text-gray-200"> 
                                            ...
                                            <div>
                                                <label for="range1" className="mb-2 inline-block"> Example range </label>
                                            ...
                                            <div>
                                                <label for="range2" className="mb-2 inline-block"> Example range </label>
                                            ...
                                            <div>
                                                <label for="range3" className="mb-2 inline-block"> Example range </label>
                                            ...
                                            <div>
                                                <label for="range4" className="mb-2 inline-block"> Example range </label>
                                            ...
                                            <div>
                                                <label for="range5" className="mb-2 inline-block"> Example range </label>
                                            ...
                                            <div>
                                                <label for="range6" className="mb-2 inline-block"> Example range </label>
                                            ...
                                            <div className="grid grid-cols-3 gap-4 mt-3 text-xs text-center font-light" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 50;repeat:true">
                                                ...
                                                <div className="group cursor-pointer" uk-toggle="target: #addPostImage; cls: brightness-125">
                                                    <div className="group-hover:ring-2 ring-blue-600 ring-offset-4 duration-500 rounded dark:ring-offset-slate-800">
                                                        <img src={Affect} alt="" className="rounded w-full h-20 object-cover brightness-125"></img>
                                                    </div>
                                                ...
                                                <div className="group cursor-pointer" uk-toggle="target: #addPostImage; cls: contrast-150">
                                                    <div className="group-hover:ring-2 ring-blue-600 ring-offset-4 duration-500 rounded dark:ring-offset-slate-800">
                                                        <img src={Affect} alt="" className="rounded w-full h-20 object-cover contrast-150"></img>
                                                    </div>
                                                    <span className="block mt-2">Contrast</span>
                                                </div>
                                                <div className="group cursor-pointer" uk-toggle="target: #addPostImage; cls: grayscale">
                                                    <div className="group-hover:ring-2 ring-blue-600 ring-offset-4 duration-500 rounded dark:ring-offset-slate-800">
                                                        <img src={Affect} alt="" className="rounded w-full h-20 object-cover grayscale"></img>
                                                    </div>
                                                ...
                                                <div className="group cursor-pointer" uk-toggle="target: #addPostImage; cls: grayscale">
                                                    <div className="group-hover:ring-2 ring-blue-600 ring-offset-4 duration-500 rounded dark:ring-offset-slate-800">
                                                        <img src={Affect} alt="" className="rounded w-full h-20 object-cover contrast"></img>
                                                    </div>
                                                    <span className="block mt-2">Contrast</span>
                                                </div>
                                                <div className="group cursor-pointer" uk-toggle="target: #addPostImage; cls: grayscale">
                                                ...
                                                <div className="group cursor-pointer" uk-toggle="target: #addPostImage; cls: hue-rotate-60">
                                                    <div className="group-hover:ring-2 ring-blue-600 ring-offset-4 duration-500 rounded dark:ring-offset-slate-800">
                                                        <img src={Affect} alt="" className="rounded w-full h-20 object-cover hue-rotate-60"></img>
                                                    </div>
                                                    <span className="block mt-2">Hue</span>
                                                </div>
                                                <div className="group cursor-pointer" uk-toggle="target: #addPostImage; cls: invert">
