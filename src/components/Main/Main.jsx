                            ...
                            <div class="py-5 uk-slider-container">
                                ...
                                <ul class="uk-slider-items w-[calc(100%+14px)]" uk-scrollspy="target: > li; cls: uk-animation-scale-up; delay: 20;repeat:true">
                                    ...
                                    <li class="md:pr-3 pr-2 hover:scale-[1.15] hover:-rotate-2 duration-300">
                                        <a href={AvatarLg1} data-caption="Caption 1">
                                            <div class="md:w-16 md:h-16 w-12 h-12 relative md:border-4 border-2 shadow border-white rounded-full overflow-hidden dark:border-slate-700">
                                                <img src={Avatar2} alt="" class="absolute w-full h-full object-cover"></img>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="md:pr-3 pr-2 hover:scale-[1.15] hover:-rotate-2 duration-300">
                                        <a href={AvatarLg2} data-caption="Caption 1">
                                            <div class="md:w-16 md:h-16 w-12 h-12 relative md:border-4 border-2 shadow border-white rounded-full overflow-hidden dark:border-slate-700">
                                                <img src={Avatar3} alt="" class="absolute w-full h-full object-cover"></img>
                                            </div>
                                        </a>
                                    </li> 
                                    <li class="md:pr-3 pr-2 hover:scale-[1.15] hover:-rotate-2 duration-300">
                                        <a href={AvatarLg3} data-caption="Caption 1">
                                            <div class="md:w-16 md:h-16 w-12 h-12 relative md:border-4 border-2 shadow border-white rounded-full overflow-hidden dark:border-slate-700">
                                                <img src={Avatar5} alt="" class="absolute w-full h-full object-cover"></img>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="md:pr-3 pr-2 hover:scale-[1.15] hover:-rotate-2 duration-300">
                                        <a href={Avatar5} data-caption="Caption 1">
                                            <div class="md:w-16 md:h-16 w-12 h-12 relative md:border-4 border-2 shadow border-white rounded-full overflow-hidden dark:border-slate-700">
                                                <img src={Avatar6} alt="" class="absolute w-full h-full object-cover"></img>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="md:pr-3 pr-2 hover:scale-[1.15] hover:-rotate-2 duration-300">
                                        <a href="assets/images/avatars/avatar-lg-1.jpg" data-caption="Caption 1">
                                            <div class="md:w-16 md:h-16 w-12 h-12 relative md:border-4 border-2 shadow border-white rounded-full overflow-hidden dark:border-slate-700">
                                                <img src={Avatar7} alt="" class="absolute w-full h-full object-cover"></img>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="md:pr-3 pr-2 hover:scale-[1.15] hover:-rotate-2 duration-300">
                    ...
                    <div class="md:max-w-[580px] mx-auto flex-1 xl:space-y-6 space-y-3">
                        ...
                        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                            ...
                            <div class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                                <a href="timeline.html"> <img src={Avatar3} alt="" class="w-9 h-9 rounded-full"></img> </a>  
                                <div class="flex-1">
                            ...
                            <a href="#preview_modal" uk-toggle>
                                <div class="relative w-full lg:h-96 h-full sm:px-4">
                                    <img src={post2} alt="" class="sm:rounded-lg w-full h-full object-cover"></img>
                                </div>
                            </a>
                            ...
                            <div class="sm:p-4 p-2.5 border-t border-gray-100 font-normal space-y-3 relative dark:border-slate-700/40"> 
                                ...
                                <div class="flex items-start gap-3 relative">
                                    <a href="timeline.html"> <img src={Avatar2} alt="" class="w-6 h-6 mt-1 rounded-full"></img> </a>
                                    <div class="flex-1">
                                ...
                                <div class="flex items-start gap-3 relative">
                                    <a href="timeline.html"> <img src={Avatar3} alt="" class="w-6 h-6 mt-1 rounded-full"></img> </a>
                                    <div class="flex-1">
                            ...
                            <div class="sm:px-4 sm:py-3 p-2.5 border-t border-gray-100 flex items-center gap-1 dark:border-slate-700/40">
                                ...
                                <img src={Avatar7} alt="" class="w-6 h-6 rounded-full"></img>
                                ...
                                <ul class="uk-slideshow-items overflow-hidden rounded-xl" uk-lightbox="animation: fade"> 
                                    <li class="w-full">
                                        <a class="inline" href="https://getuikit.com/docs/images/photo3.jpg" data-caption="Caption 1"> 
                                            <img src={post2} alt="" class="w-full h-full absolute object-cover insta-0"></img>
                                        </a>
                                    </li>
                                    <li class="w-full">
                                        <a class="inline" href="https://getuikit.com/docs/images/photo2.jpg" data-caption="Caption 2"> 
                                            <img src={post3} alt="" class="w-full h-full absolute object-cover insta-0"></img>
                                        </a>
                                    </li>
                                    <li class="w-full">
                                        <a class="inline" href="https://getuikit.com/docs/images/photo.jpg" data-caption="Caption 3"> 
                                            <img src={post4} alt="" class="w-full h-full absolute object-cover insta-0"></img>
                                        </a>
                                    </li> 
                                </ul>
                        ...
                        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                            ...
                            {/* <!-- post heading --> */}
                            <div class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                                <a href="timeline.html"> <img src={Avatar5} alt="" class="w-9 h-9 rounded-full"></img> </a> 
                                <div class="flex-1">
                            ...
                            <div class="sm:p-4 p-2.5 border-t border-gray-100 font-normal space-y-3 relative dark:border-slate-700/40"> 
                                ...
                                <div class="flex items-start gap-3 relative">
                                    <a href="timeline.html"> <img src={Avatar5} alt="" class="w-6 h-6 mt-1 rounded-full"></img> </a>
                                    <div class="flex-1">
                ...
                <div class="flex-1"> 
                        ...
                        <div class="side-list">
                            ...
                            <div class="side-list-item">
                                <a href="timeline.html">
                                    <img src={Avatar2} alt="" class="side-list-image rounded-full"></img>
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="side-list-item">
                                <a href="timeline.html">
                                    <img src={Avatar3} alt="" class="side-list-image rounded-full"></img>
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="side-list-item">
                                <a href="timeline.html">
                                    <img src={Avatar5} alt="" class="side-list-image rounded-full"></img>
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="side-list-item">
                                <a href="timeline.html">
                                    <img src={Avatar6} alt="" class="side-list-image rounded-full"></img>
                                </a>
                                <div class="flex-1">
                    ...
                    <div class="box p-5 px-6 border1 dark:bg-dark2 hidden">
                        ...
                        <div class="space-y-4 capitalize text-xs font-normal mt-5 mb-2 text-gray-500 dark:text-white/80">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src={Avatar7} alt="" class="bg-gray-200 rounded-full w-10 h-10"></img>
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src={Avatar5} alt="" class="bg-gray-200 rounded-full w-10 h-10"></img>
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src={Avatar2} alt="" class="bg-gray-200 rounded-full w-10 h-10"></img>
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src={Avatar3} alt="" class="bg-gray-200 rounded-full w-10 h-10"></img>
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src={Avatar4} alt="" class="bg-gray-200 rounded-full w-10 h-10"></img>
                                </a>
                                <div class="flex-1">
...
<div class="box p-5 px-6 border1 dark:bg-dark2">
                        ...
                        <div class="grid grid-cols-6 gap-3 mt-4">
                            ...
                            <a href="timeline.html"> 
                                <div class="w-10 h-10 relative">
                                    <img src={Avatar2} alt="" class="w-full h-full absolute inset-0 rounded-full"></img>
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                            <a href="timeline.html"> 
                                <div class="w-10 h-10 relative">
                                    <img src={Avatar3} alt="" class="w-full h-full absolute inset-0 rounded-full"></img>
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div>
                            </a>
                            <a href="timeline.html">  
                                <div class="w-10 h-10 relative">
                                    <img src={Avatar4} alt="" class="w-full h-full absolute inset-0 rounded-full"></img>
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                            <a href="timeline.html"> 
                                <div class="w-10 h-10 relative">
                                    <img src={Avatar5} alt="" class="w-full h-full absolute inset-0 rounded-full"></img>
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                            <a href="timeline.html"> 
                                <div class="w-10 h-10 relative">
                                    <img src={Avatar6} alt="" class="w-full h-full absolute inset-0 rounded-full"></img>
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                            <a href="timeline.html"> 
                                <div class="w-10 h-10 relative">
                                    <img src={Avatar7} alt="" class="w-full h-full absolute inset-0 rounded-full"></img>
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                    ...
                    <div class="box p-5 px-6 border1 dark:bg-dark2">
                        ...
                        <div class="flex justify-between text-black dark:text-white">
                            <h3 class="font-bold text-base"> Latest Trends </h3>
                            <button type="button"> <ion-icon name="sync-outline" class="text-xl"></ion-icon> </button>
                        </div>
                                ...
                                <ul class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]">
                                        ...
                                        <a href="#">
                                            <div class="relative overflow-hidden rounded-lg">
                                                <div class="relative w-full h-40">
                                                    <img src={Product1} alt="" class="object-cover w-full h-full inset-0"></img>
                                                </div> 
                                    ...
                                    <li class="w-1/2 pr-2">
                                        ...
                                        <a href="#">
                                            <div class="relative overflow-hidden rounded-lg">
                                                <div class="relative w-full h-40">
                                                    <img src={Product3} alt="" class="object-cover w-full h-full inset-0"></img>
                                                </div> 
                                    ...
                                    <li class="w-1/2 pr-2">
                                        ...
                                        <a href="#">
                                            <div class="relative overflow-hidden rounded-lg">
                                                <div class="relative w-full h-40">
                                                    <img src={Product5} alt="" class="object-cover w-full h-full inset-0"></img>
                                                </div> 
                                                <div class="absolute right-0 top-0 m-2 bg-white/60 rounded-full py-0.5 px-2 text-sm font-semibold dark:bg-slate-800/60"> $12 </div>
                                            </div>
                                ...
                                <ul class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]">
                                            ...
                                            <div class="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                                <a href="timeline.html"> 
                                                    <div class="relative w-16 h-16 mx-auto mt-2">
                                                        <img src={Avatar5} alt="" class="h-full object-cover rounded-full shadow w-full"></img>
                                                    </div>
                                                </a>
                                    ...
                                    <li class="w-1/2 pr-2">
                                        <div class="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                            <a href="timeline.html"> 
                                                <div class="relative w-16 h-16 mx-auto mt-2">
                                                    <img src={Avatar4} alt="" class="h-full object-cover rounded-full shadow w-full"></img>
                                                </div>
                                            </a> 
                                            <div class="mt-5 text-center w-full">
