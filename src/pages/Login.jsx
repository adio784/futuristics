        ...
        <div class="sm:flex">
            ...
            <div class="relative lg:w-[580px] md:w-96 w-full p-10 min-h-screen bg-white shadow-xl flex pt-10 z-10">
                ...
                <div class="w-full lg:max-w-sm mx-auto space-y-10" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
                    ...
                    {/* <!-- title --> */}
                    <div>
                        <p className="text-3xl text-gray-700 font-bold mt-4 mb-2">Welcome Back!</p>
                        <p class="text-sm text-gray-700 font-normal">If you haven’t signed up yet. <a href="register" class="text-gold-600">Register here!</a></p>
                    </div>
                    ...
                    {/* <!-- email --> */}
                    <div>
                        <label for="email" class="">Email address / Phone Number</label>
                        <div class="mt-2.5">
                            <input id="email" name="email" type="email" autofocus=""  placeholder="Email or phone" required="" class="!w-full !rounded-lg text-black bg-black !shadow-sm !border-slate-200 dark:!border-slate-800"/> 
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2.5">
                            <input id="password" name="password" type="password" placeholder="***"  class="!w-full !text-gray-70 !rounded-lg !shadow-sm !border-slate-200 dark:!border-slate-800 "/>  
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-gold-600">Forgot password </a>
                    </div>

                    {/* <!-- submit button --> */}
                    <div>
                        <button type="submit" class="button bg-black text-white w-full" onClick={''}>Sign in</button>
